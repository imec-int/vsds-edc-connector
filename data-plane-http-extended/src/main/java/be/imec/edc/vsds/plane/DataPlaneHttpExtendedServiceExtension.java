package be.imec.edc.vsds.plane;

import be.imec.edc.vsds.plane.params.HttpRequestFactory;
import be.imec.edc.vsds.plane.params.HttpRequestParamsProviderImpl;
import be.imec.edc.vsds.plane.pipeline.HttpDataSinkFactory;
import be.imec.edc.vsds.plane.pipeline.HttpDataSourceFactory;
...
@Extension(value = DataPlaneHttpExtendedServiceExtension.NAME)
public class DataPlaneHttpExtendedServiceExtension implements ServiceExtension {

    public static final String NAME = "Extended HTTP Data Plane";
